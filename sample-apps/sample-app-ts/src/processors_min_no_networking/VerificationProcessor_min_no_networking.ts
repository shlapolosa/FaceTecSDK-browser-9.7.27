...
// NOTE: This example DOES NOT perform a secure Verification.  To perform a secure Verification, you need to actually make an API call.
// Please see the VerificationProcessor file for a complete demonstration using the FaceTec Testing API.
