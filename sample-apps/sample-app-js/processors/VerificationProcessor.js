//
// Welcome to the annotated FaceTec Device SDK core code for performing secure Verification against a previously enrolled user.
//
//
// This is an example self-contained class to perform Verification with the FaceTec SDK.
// You may choose to further componentize parts of this in your own Apps based on your specific requirements.
//
var VerificationProcessor = /** @class */ (function () {
    function VerificationProcessor(sessionToken, sampleAppControllerReference) {
        var _this = this;
    ...
    //
    VerificationProcessor.prototype.processSessionResultWhileFaceTecSDKWaits = function (sessionResult, faceScanResultCallback) {
        var _this = this;
        ...
        // IMPORTANT:  FaceTecSDK.FaceTecSessionStatus.SessionCompletedSuccessfully DOES NOT mean the Verification was Successful.
        // It simply means the User completed the Session and a 3D FaceScan was created.  You still need to perform the Verification on your Servers.
        //
...
var VerificationProcessor = VerificationProcessor;
